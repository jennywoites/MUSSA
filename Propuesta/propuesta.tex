...
% BEGIN Referencia
\bibitem{PAPER_ROSITA_PLANNING_WITH_PREFERENCES} \textit{<<Planning with Prederences>>}
...
% BEGIN Referencia
\bibitem{PAPER_ROSITA_PLANNING_WITH_PREFERENCES_2} \textit{<<HTN Planning with Preferences>>}
...
% BEGIN Referencia
\bibitem{PAPER_ROSITA_PLANNING_WITH_PREFERENCES_3} \textit{<<Learning Probabilistic Hierarchical Task Networks as Probabilistic Context-Free Grammars to Capture User Preferences>>}
...
% BEGIN Referencia
\bibitem{PAPER_ROSITA_PLANNING_WITH_PREFERENCES_4} \textit{<<Learning Probabilistic Hierarchical Task Networks to Capture User Preferences>>}
