...
H_1_2_01 = LpVariable(name='H_1_2_01', cat='Binary')
H_3_5_01 = LpVariable(name='H_3_5_01', cat='Binary')
H_2_3_01 = LpVariable(name='H_2_3_01', cat='Binary')
H_2_4_01 = LpVariable(name='H_2_4_01', cat='Binary')
H_1_1_02 = LpVariable(name='H_1_1_02', cat='Binary')
...
H_2_4_02 = LpVariable(name='H_2_4_02', cat='Binary')
H_1_1_03 = LpVariable(name='H_1_1_03', cat='Binary')
H_1_2_03 = LpVariable(name='H_1_2_03', cat='Binary')
H_3_5_03 = LpVariable(name='H_3_5_03', cat='Binary')
H_2_3_03 = LpVariable(name='H_2_3_03', cat='Binary')
H_2_4_03 = LpVariable(name='H_2_4_03', cat='Binary')
H_1_1_04 = LpVariable(name='H_1_1_04', cat='Binary')
...
H_2_4_04 = LpVariable(name='H_2_4_04', cat='Binary')
...
prob += (Y_1_01 >= H_1_2_01)
prob += (Y_3_01 >= H_3_5_01)
prob += (Y_2_01 >= H_2_3_01)
prob += (Y_2_01 >= H_2_4_01)
prob += (Y_1_02 >= H_1_1_02)
prob += (Y_1_02 >= H_1_2_02)
prob += (Y_3_02 >= H_3_5_02)
prob += (Y_2_02 >= H_2_3_02)
prob += (Y_2_02 >= H_2_4_02)
prob += (Y_1_03 >= H_1_1_03)
prob += (Y_1_03 >= H_1_2_03)
prob += (Y_3_03 >= H_3_5_03)
prob += (Y_2_03 >= H_2_3_03)
prob += (Y_2_03 >= H_2_4_03)
prob += (Y_1_04 >= H_1_1_04)
prob += (Y_1_04 >= H_1_2_04)
prob += (Y_3_04 >= H_3_5_04)
prob += (Y_2_04 >= H_2_3_04)
prob += (Y_2_04 >= H_2_4_04)

# La materia no puede cursarse en mas de un curso en el cuatrimestre

prob += (Y_1_01 <= H_1_1_01 + H_1_2_01)
prob += (Y_1_01 >= H_1_1_01 + H_1_2_01)
prob += (Y_3_01 <= H_3_5_01)
prob += (Y_3_01 >= H_3_5_01)
prob += (Y_2_01 <= H_2_3_01 + H_2_4_01)
prob += (Y_2_01 >= H_2_3_01 + H_2_4_01)
prob += (Y_1_02 <= H_1_1_02 + H_1_2_02)
prob += (Y_1_02 >= H_1_1_02 + H_1_2_02)
prob += (Y_3_02 <= H_3_5_02)
prob += (Y_3_02 >= H_3_5_02)
prob += (Y_2_02 <= H_2_3_02 + H_2_4_02)
prob += (Y_2_02 >= H_2_3_02 + H_2_4_02)
prob += (Y_1_03 <= H_1_1_03 + H_1_2_03)
prob += (Y_1_03 >= H_1_1_03 + H_1_2_03)
prob += (Y_3_03 <= H_3_5_03)
prob += (Y_3_03 >= H_3_5_03)
prob += (Y_2_03 <= H_2_3_03 + H_2_4_03)
prob += (Y_2_03 >= H_2_3_03 + H_2_4_03)
prob += (Y_1_04 <= H_1_1_04 + H_1_2_04)
prob += (Y_1_04 >= H_1_1_04 + H_1_2_04)
prob += (Y_3_04 <= H_3_5_04)
prob += (Y_3_04 >= H_3_5_04)
prob += (Y_2_04 <= H_2_3_04 + H_2_4_04)
prob += (Y_2_04 >= H_2_3_04 + H_2_4_04)
...
with open('resultados_tests/test_con_cursos_dictados_en_un_unico_cuatrimestre_resultados_pulp.py', 'w') as arch:
    ...
    arch.write("H_1_2_01;{}".format(int(value(H_1_2_01))) + "\n")
    arch.write("H_3_5_01;{}".format(int(value(H_3_5_01))) + "\n")
    arch.write("H_2_3_01;{}".format(int(value(H_2_3_01))) + "\n")
    arch.write("H_2_4_01;{}".format(int(value(H_2_4_01))) + "\n")
    arch.write("H_1_1_02;{}".format(int(value(H_1_1_02))) + "\n")
    ...
    arch.write("H_2_4_02;{}".format(int(value(H_2_4_02))) + "\n")
    arch.write("H_1_1_03;{}".format(int(value(H_1_1_03))) + "\n")
    arch.write("H_1_2_03;{}".format(int(value(H_1_2_03))) + "\n")
    arch.write("H_3_5_03;{}".format(int(value(H_3_5_03))) + "\n")
    arch.write("H_2_3_03;{}".format(int(value(H_2_3_03))) + "\n")
    arch.write("H_2_4_03;{}".format(int(value(H_2_4_03))) + "\n")
    arch.write("H_1_1_04;{}".format(int(value(H_1_1_04))) + "\n")
    ...
    arch.write("H_2_4_04;{}".format(int(value(H_2_4_04))) + "\n")
