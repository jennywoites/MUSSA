...
prob += (Y_A_01 + Y_B_01 + Y_C_01 <= 3)
prob += (Y_A_02 + Y_B_02 + Y_C_02 <= 3)
prob += (Y_A_03 + Y_B_03 + Y_C_03 <= 3)
...
prob += (1*Y_A_01 + 1*Y_B_01 + 1*Y_C_01  <= CRED01)
prob += (1*Y_A_01 + 1*Y_B_01 + 1*Y_C_01  >= CRED01)
prob += (1*Y_A_02 + 1*Y_B_02 + 1*Y_C_02 + CRED01 <= CRED02)
prob += (1*Y_A_02 + 1*Y_B_02 + 1*Y_C_02 + CRED01 >= CRED02)
prob += (1*Y_A_03 + 1*Y_B_03 + 1*Y_C_03 + CRED02 <= CRED03)
prob += (1*Y_A_03 + 1*Y_B_03 + 1*Y_C_03 + CRED02 >= CRED03)
