...
R_C_Curso1C_LUNES_3_01 = LpVariable(name='R_C_Curso1C_LUNES_3_01', cat='Binary')
...
R_C_Curso1C_LUNES_3_02 = LpVariable(name='R_C_Curso1C_LUNES_3_02', cat='Binary')
...
R_C_Curso1C_LUNES_3_03 = LpVariable(name='R_C_Curso1C_LUNES_3_03', cat='Binary')
...
prob += (1*Y_A_01 + 1*Y_C_01 + 1*Y_B_01 + 1*Y_E_01 + 1*Y_D_01  <= CRED01)
prob += (1*Y_A_01 + 1*Y_C_01 + 1*Y_B_01 + 1*Y_E_01 + 1*Y_D_01  >= CRED01)
prob += (1*Y_A_02 + 1*Y_C_02 + 1*Y_B_02 + 1*Y_E_02 + 1*Y_D_02 + CRED01 <= CRED02)
prob += (1*Y_A_02 + 1*Y_C_02 + 1*Y_B_02 + 1*Y_E_02 + 1*Y_D_02 + CRED01 >= CRED02)
prob += (1*Y_A_03 + 1*Y_C_03 + 1*Y_B_03 + 1*Y_E_03 + 1*Y_D_03 + CRED02 <= CRED03)
prob += (1*Y_A_03 + 1*Y_C_03 + 1*Y_B_03 + 1*Y_E_03 + 1*Y_D_03 + CRED02 >= CRED03)
...
prob += (H_A_Curso1A_01 >= R_A_Curso1A_LUNES_1_01)
prob += (H_C_Curso1C_01 <= R_C_Curso1C_LUNES_3_01)
prob += (H_C_Curso1C_01 >= R_C_Curso1C_LUNES_3_01)
...
prob += (H_A_Curso1A_02 >= R_A_Curso1A_LUNES_1_02)
prob += (H_C_Curso1C_02 <= R_C_Curso1C_LUNES_3_02)
prob += (H_C_Curso1C_02 >= R_C_Curso1C_LUNES_3_02)
...
prob += (H_A_Curso1A_03 >= R_A_Curso1A_LUNES_1_03)
prob += (H_C_Curso1C_03 <= R_C_Curso1C_LUNES_3_03)
prob += (H_C_Curso1C_03 >= R_C_Curso1C_LUNES_3_03)
...
prob += (LUNES_1_01 >= R_A_Curso1A_LUNES_1_01)
prob += (LUNES_2_01 <= R_B_Curso1B_LUNES_2_01)
prob += (LUNES_2_01 >= R_B_Curso1B_LUNES_2_01)
prob += (LUNES_3_01 <= R_C_Curso1C_LUNES_3_01)
prob += (LUNES_3_01 >= R_C_Curso1C_LUNES_3_01)
prob += (LUNES_4_01 <= R_D_Curso1D_LUNES_4_01)
prob += (LUNES_4_01 >= R_D_Curso1D_LUNES_4_01)
prob += (LUNES_5_01 <= R_E_Curso1E_LUNES_5_01)
prob += (LUNES_5_01 >= R_E_Curso1E_LUNES_5_01)
prob += (LUNES_1_02 <= R_A_Curso1A_LUNES_1_02)
prob += (LUNES_1_02 >= R_A_Curso1A_LUNES_1_02)
prob += (LUNES_2_02 <= R_B_Curso1B_LUNES_2_02)
prob += (LUNES_2_02 >= R_B_Curso1B_LUNES_2_02)
prob += (LUNES_3_02 <= R_C_Curso1C_LUNES_3_02)
prob += (LUNES_3_02 >= R_C_Curso1C_LUNES_3_02)
prob += (LUNES_4_02 <= R_D_Curso1D_LUNES_4_02)
prob += (LUNES_4_02 >= R_D_Curso1D_LUNES_4_02)
prob += (LUNES_5_02 <= R_E_Curso1E_LUNES_5_02)
prob += (LUNES_5_02 >= R_E_Curso1E_LUNES_5_02)
prob += (LUNES_1_03 <= R_A_Curso1A_LUNES_1_03)
prob += (LUNES_1_03 >= R_A_Curso1A_LUNES_1_03)
prob += (LUNES_2_03 <= R_B_Curso1B_LUNES_2_03)
prob += (LUNES_2_03 >= R_B_Curso1B_LUNES_2_03)
prob += (LUNES_3_03 <= R_C_Curso1C_LUNES_3_03)
prob += (LUNES_3_03 >= R_C_Curso1C_LUNES_3_03)
prob += (LUNES_4_03 <= R_D_Curso1D_LUNES_4_03)
prob += (LUNES_4_03 >= R_D_Curso1D_LUNES_4_03)
prob += (LUNES_5_03 <= R_E_Curso1E_LUNES_5_03)
prob += (LUNES_5_03 >= R_E_Curso1E_LUNES_5_03)
...
with open('resultados_tests/test_correlatividades_se_hacen_en_orden_varios_niveles_correlatividades_resultados_pulp.py', 'w') as arch:
    ...
    arch.write("LUNES_6_03;0" + '\n')
    arch.write("R_A_Curso1A_LUNES_1_01;{}".format(int(value(R_A_Curso1A_LUNES_1_01))) + "\n")
    arch.write("R_C_Curso1C_LUNES_3_01;{}".format(int(value(R_C_Curso1C_LUNES_3_01))) + "\n")
    ...
    arch.write("R_C_Curso1C_LUNES_3_02;{}".format(int(value(R_C_Curso1C_LUNES_3_02))) + "\n")
    ...
    arch.write("R_C_Curso1C_LUNES_3_03;{}".format(int(value(R_C_Curso1C_LUNES_3_03))) + "\n")
