...
class Test_con_cursos_dictados_en_un_unico_cuatrimestre(TestPulp):
    ...
    def no_se_elige_un_horario_no_disponible_ese_cuatrimestre(self, parametros, resultados):
        ...
        assert(resultados["H_A_Curso1A_02"] == 0)
        assert(resultados["H_B_Curso2B_02"] == 0)

        assert(resultados["H_A_Curso2A_03"] == 0)
        assert(resultados["H_B_Curso1B_03"] == 0)

        assert(resultados["H_A_Curso1A_04"] == 0)
        assert(resultados["H_B_Curso2B_04"] == 0)
