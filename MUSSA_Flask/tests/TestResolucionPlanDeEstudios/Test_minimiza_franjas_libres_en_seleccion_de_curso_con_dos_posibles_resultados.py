...
class Test_minimiza_franjas_libres_en_seleccion_de_curso_con_dos_posibles_resultados(TestPulp):
    ...
    def numero_combinacion_seleccionada(self, resultados):
        if resultados["H_A_Curso3A_01"] and resultados["H_B_Curso1B_01"] :
            return COMBINACION_CURSOS_A3_B1

        if resultados["H_A_Curso3A_01"] and resultados["H_B_Curso3B_01"] :
    ...
    def los_cursos_se_eligieron_correctamente_A3_B1(self, parametros, resultados):
        ...
        #Curso 2A
        assert(resultados["H_A_Curso2A_01"] == 0)
        assert(resultados["R_A_Curso2A_LUNES_2_01"] == 0)
        assert(resultados["R_A_Curso2A_LUNES_3_01"] == 0)
        assert(resultados["R_A_Curso2A_LUNES_5_01"] == 0)
        assert(resultados["R_A_Curso2A_LUNES_6_01"] == 0)
        assert(resultados["R_A_Curso2A_LUNES_7_01"] == 0)

        #Curso 3A
        assert(resultados["H_A_Curso3A_01"] == 1)
        assert(resultados["R_A_Curso3A_LUNES_4_01"] == 1)
        assert(resultados["R_A_Curso3A_LUNES_5_01"] == 1)
        assert(resultados["R_A_Curso3A_LUNES_6_01"] == 1)

        #Curso 1B
        assert(resultados["H_B_Curso1B_01"] == 1)
        assert(resultados["R_B_Curso1B_LUNES_1_01"] == 1)
        assert(resultados["R_B_Curso1B_LUNES_2_01"] == 1)
        assert(resultados["R_B_Curso1B_LUNES_3_01"] == 1)

        #Curso 2B
        assert(resultados["H_B_Curso2B_01"] == 0)
        assert(resultados["R_B_Curso2B_LUNES_4_01"] == 0)
        assert(resultados["R_B_Curso2B_LUNES_9_01"] == 0)
    ...
    def los_cursos_se_eligieron_correctamente_A3_B3(self, parametros, resultados):
        ...
        #Curso 3B
        assert(resultados["H_B_Curso3B_01"] == 1)
        assert(resultados["R_B_Curso3B_LUNES_7_01"] == 1)
        assert(resultados["R_B_Curso3B_LUNES_8_01"] == 1)
        assert(resultados["R_B_Curso3B_LUNES_9_01"] == 1)
        assert(resultados["R_B_Curso3B_LUNES_10_01"] == 1)
    ...
    def las_horas_libres_se_calculan_correctamente_A3_B1(self, parametros, resultados):
        ...
        assert(resultados["LUNES_1_01"] == 1)
        ...
        assert(resultados["LUNES_7_01"] == 0)
        assert(resultados["LUNES_8_01"] == 0)
        assert(resultados["LUNES_9_01"] == 0)
        ...
        assert(resultados["MINIMA_FRANJA_LUNES_01"] == 1)        
        assert(resultados["MAXIMA_FRANJA_LUNES_01"] == 6)
        assert(resultados["HORAS_LIBRES_LUNES_01"] == 0)
    ...
    def las_horas_libres_se_calculan_correctamente_A3_B3(self, parametros, resultados):
        ...
        assert(resultados["LUNES_2_01"] == 0)
        assert(resultados["LUNES_3_01"] == 0)
        assert(resultados["LUNES_4_01"] == 1)
        assert(resultados["LUNES_5_01"] == 1)
        assert(resultados["LUNES_6_01"] == 1)
        assert(resultados["LUNES_7_01"] == 1)
        assert(resultados["LUNES_8_01"] == 1)
        assert(resultados["LUNES_9_01"] == 1)
        assert(resultados["LUNES_10_01"] == 1)
        assert(resultados["LUNES_11_01"] == 0)
        assert(resultados["LUNES_12_01"] == 0)

        assert(resultados["OCUPADO_LUNES_01"] == 1)
        assert(resultados["MINIMA_FRANJA_LUNES_01"] == 4)        
        assert(resultados["MAXIMA_FRANJA_LUNES_01"] == 10)
        assert(resultados["HORAS_LIBRES_LUNES_01"] == 0)
