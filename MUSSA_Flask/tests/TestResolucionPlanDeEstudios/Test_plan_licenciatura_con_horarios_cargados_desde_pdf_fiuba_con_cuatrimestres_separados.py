...
class Test_plan_licenciatura_con_horarios_cargados_desde_pdf_fiuba_con_cuatrimestres_separados(
    TestConHorariosPDFSeparadosEnCuatrimestres):
    def get_nombre_test(self):
        return "test_plan_licenciatura_con_horarios_cargados_desde_pdf_fiuba_con_cuatrimestres_separados"
...
if __name__ == "__main__":
    test_a_ejecutar = Test_plan_licenciatura_con_horarios_cargados_desde_pdf_fiuba_con_cuatrimestres_separados()
