...
from app.models.generadorJSON.preguntas_resultados_encuesta_generadorJSON import generarJSON_pregunta_resultados
from app.API_Rest.codes import *


class PreguntasResultadosEncuestaService(BaseService):
    def getNombreClaseServicio(self):
        return "Preguntas Resultados Encuesta Service"
    ...
    def get(self):
        ...
        for encuesta in filtrar_encuestas(filtros):
            preguntas_result.append(generarJSON_pregunta_resultados(encuesta))
...
#########################################
CLASE = PreguntasResultadosEncuestaService
URLS_SERVICIOS = (
    '/api/encuesta/resultados/preguntas',
)
#########################################
