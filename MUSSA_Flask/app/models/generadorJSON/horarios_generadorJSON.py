...
def generarJSON_curso(curso):
    ...
    return generarJSON_curso_con_filtros(curso, carreras_response, horarios_response, docentes, docentes_response)


def generarJSON_curso_con_filtros(curso, carreras_response, horarios_response, docentes, docentes_response):
    return {
        'id_curso': curso.id,
